        ...
        function fetchAll()
{
    ...
    return $data;
        ...
        {
            try {
                $sql = "INSERT INTO chairpersons (name, title, honorifics_id) VALUES (:name, :title, :honorifics_id)";
                $query = $this->db->connect()->prepare($sql);
        ...
        {
            $sql = "SELECT * FROM chairpersons WHERE id = :recordID;";
            $query = $this->db->connect()->prepare($sql);
        ...
        function edit()
        {
            $sql = "UPDATE chairpersons SET name = :name, title = :title, honorifics_id = :honorifics_id WHERE id = :id;";
            $query = $this->db->connect()->prepare($sql);
