        ...
        <div class="president-section">
            <div class="profile-bubble-container">
                ...
                <div class="profile-bubble">
                    <img src="Board of Regents/carla-ochotorena.jpg" alt="Dr. Ma. Carla A. Ochotorena" class="profile-image">
                </div>
            </div>
            
            <div class="president-info">
                <h2>Dr. Ma. Carla A. Ochotorena</h2>
                <h3>University President</h3>
                <button class="sub-offices-btn">See Sub-Offices</button>
                <a href="#" class="office-link">Proceed to President's Office Page</a>
            </div>
        </div>
