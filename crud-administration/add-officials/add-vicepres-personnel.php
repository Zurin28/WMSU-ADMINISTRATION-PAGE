    ...
    <select name="honorifics" id="honorifics" class="form-control border-danger" style="border-width: 2px;" required>
        ...
        ?>
            ...
            <div class="form-group">
                ...
                <select name="offices" id="offices" class="form-control border-danger" style="border-width: 2px;" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="PersonnelName" id="PersonnelName" class="form-control border-danger" style="border-width: 2px;" required>
            </div>
